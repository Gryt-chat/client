...
setAnnouncedPlugins("one.example", [
  { id: "presence", version: "2.1.0", capabilities: ["messaging"] },
]);
setAnnouncedPlugins("two.example", [
  { id: "scoreboard", version: "1.0.0", capabilities: [] },
]);
setAnnouncedPlugins("three.example", [
  { id: "presence", version: "1.4.0", capabilities: ["messaging"] },
  { id: "scoreboard", version: "9.9.9", capabilities: ["messages:read", "moderation"] },
]);
