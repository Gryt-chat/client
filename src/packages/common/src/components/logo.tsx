  ...
  return (
    ...
    >
      <g clipPath="url(#logo-clip)">
        <rect width="512" height="512" rx="256" fill={beta ? BETA_ACCENT : "#968FF8"} />
        ...
        {/* The owl winks on a beta build. Nobody who is not looking for it
            will notice; everyone who ships betas will. */}
        {beta ? (
          <path
            d="M186 180 Q205 194 224 180"
            stroke="#CBCBCE"
            strokeWidth="9"
            strokeLinecap="round"
            fill="none"
