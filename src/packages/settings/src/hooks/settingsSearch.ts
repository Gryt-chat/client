...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  { id: "microphone-volume", title: "Microphone Volume", description: "Your microphone input level (100% = unchanged, 200% = 2x boost)", destination: "sound-video", section: "Audio Settings" },
  { id: "test-microphone-playback", title: "Test Microphone (Playback)", description: "Hear yourself through speakers/headphones. Useful for verifying your audio processing settings.", destination: "sound-video", section: "Audio Settings" },
  { id: "noise-reduction-rnnoise", title: "Noise Reduction (RNNoise)", description: "AI-powered noise reduction. Processes audio off the main thread via AudioWorklet for low-latency noise suppression (~20 ms).", destination: "sound-video", section: "Audio Settings" },
  { id: "auto-gain", title: "Auto Gain", description: "Normalizes your microphone to a target volume level. Quiet speech gets boosted, loud speech gets reduced.", destination: "sound-video", section: "Audio Settings" },
  { id: "target-level", title: "Target Level", description: "The volume level your voice will be normalized to. Lower values = quieter output, higher = louder.", destination: "sound-video", section: "Audio Settings" },
  { id: "compressor", title: "Compressor", description: "Reduces dynamic range so your volume stays more consistent. Tames peaks and evens out your voice after auto gain.", destination: "sound-video", section: "Audio Settings" },
  { id: "compression-amount", title: "Compression Amount", description: "How aggressively to compress. Low = subtle leveling, high = heavy squash.", destination: "sound-video", section: "Audio Settings" },
  { id: "output-volume", title: "Output Volume", description: "Controls volume of all incoming audio (100% = unchanged, 200% = 2x boost)", destination: "sound-video", section: "Audio Settings" },
  { id: "input-mode", title: "Input Mode", description: "Voice Activity transmits whenever you speak above the noise gate. Push to Talk requires holding a key.", destination: "sound-video", section: "Voice" },
  { id: "afk-timeout", title: "AFK Timeout", description: "You'll be marked as AFK after this many minutes of silence. Only applies when connected to voice channels.", destination: "sound-video", section: "Voice" },
  ...
  { id: "start-with-windows", title: "Start with Windows", description: "Automatically launch Gryt when you sign in to Windows.", destination: "behaviour", section: "Desktop" },
  ...
  { id: "minimize-to-tray-on-close", title: "Minimize to Tray on Close", description: "When enabled, closing the window minimizes to the system tray instead of quitting the app.", destination: "behaviour", section: "Desktop" },
  { id: "hardware-acceleration", title: "Hardware Acceleration", description: "Uses your GPU for rendering. Disable if you experience visual glitches or high GPU usage. Changing this will restart the app.", destination: "behaviour", section: "Desktop" },
  { id: "esports-mode", title: "eSports Mode", description: "Lowest possible latency. Disables all audio processing, enables push-to-talk, caps bitrate at 128kbps (studio quality), and optimizes Opus packetization (10ms frames).", destination: "behaviour", section: "Advanced" },
  { id: "experimental-screen-share", title: "Experimental Screen Share", description: "Unlock high frame rate options (144, 165, 240 FPS) for screen sharing. These require significant bandwidth and may not work on all hardware.", destination: "behaviour", section: "Advanced" },
