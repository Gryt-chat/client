...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  { id: "appearance", title: "Appearance", description: "Mode, themes, sizes and chat.", page: "theme", destination: "appearance", section: "Theme", panel: true },
  ...
  { id: "load-link-embeds-automatically", title: "Load link embeds automatically", description: "A YouTube, Spotify, Twitch, SoundCloud, TikTok, Instagram, Vimeo or X embed is that company's own page running inside Gryt, and it can see that you opened it. Off, they wait for you to press Load.", page: "chat", destination: "appearance", section: "Chat" },
