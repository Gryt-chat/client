...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  { id: "test-microphone-playback", title: "Test microphone", description: "Hear yourself through your speakers or headphones, to check what the processing is doing.", destination: "sound-video", section: "Audio Settings" },
  { id: "noise-reduction-rnnoise", title: "Noise reduction", description: "Removes background noise before your voice is sent. Runs in an AudioWorklet off the main thread, and adds about 20 ms.", destination: "sound-video", section: "Audio Settings" },
  { id: "auto-gain", title: "Auto gain", description: "Brings your microphone to a target volume. Quiet speech is boosted, loud speech is reduced.", destination: "sound-video", section: "Audio Settings" },
  { id: "target-level", title: "Target level", description: "The volume your voice is brought to. Lower is quieter, higher is louder.", destination: "sound-video", section: "Audio Settings" },
  { id: "compressor", title: "Compressor", description: "Narrows the gap between your quietest and loudest, so your level stays steadier. Runs after auto gain.", destination: "sound-video", section: "Audio Settings" },
  ...
  { id: "output-volume", title: "Output volume", description: "Volume of all incoming audio (100% = unchanged, 200% = 2x boost)", destination: "sound-video", section: "Audio Settings" },
  ...
  { id: "afk-timeout", title: "AFK timeout", description: "You are marked AFK after this many minutes of silence, and only while you are connected to voice.", destination: "sound-video", section: "Voice" },
