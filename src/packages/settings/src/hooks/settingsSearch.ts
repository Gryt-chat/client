...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  { id: "two-person-layout", title: "Two people", description: "What a channel with exactly two people in it looks like. One large and one small puts the other person in the panel and you in the corner; same size gives you both the same tile, stacked in the sidebar and side by side once there is room.", page: "voice", destination: "sound-video", section: "Voice" },
