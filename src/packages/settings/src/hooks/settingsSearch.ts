...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  { id: "tile-layout", title: "Tile layout", description: "How the voice grid arranges people once it is maximised. Match Google Meet allows tall narrow tiles and more columns; Biggest tiles picks whichever arrangement makes them largest.", destination: "looks", section: "Appearance" },
