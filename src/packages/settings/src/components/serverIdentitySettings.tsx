...
import { PiHardDrives, PiShieldCheck, PiTrash, PiWarning } from "react-icons/pi";
  ...
  return (
    ...
    >
      <Flex align="center" gap="2">
        <PiWarning size={18} style={{ color: "var(--red-11)", flexShrink: 0 }} />
...
function KnownRow({ pin, onForget }: { pin: ServerPin; onForget: (keyId: string) => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <PiShieldCheck size={18} style={{ color: "var(--accent-11)" }} />
      </Flex>
    ...
    <SettingsContainer>
      ...
      <Flex direction="column" gap="3">
        ...
        {pins.length === 0 ? (
          ...
          >
            <PiHardDrives size={32} style={{ color: "var(--gray-a8)" }} />
