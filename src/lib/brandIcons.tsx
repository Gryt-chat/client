...
function brand(viewBox: string, d: string, name: string) {
  const Mark = ({ size = 16, className }: BrandIconProps) => (
    <svg
      width={size}
      height={size}
      viewBox={viewBox}
  ...
  Mark.displayName = name;
  return Mark;
}

export const FaGithub = brand(
  "0 0 496 512",
